    ...
    return ( 
        ...
        <div className='container border-top mt-5'>
            ...
            <div className='row mt-5'>
                <div className='col'>
                    <img src="media/Images/logo.svg" alt='img' style={{width : "50%"}}/>
                    <p>&copy; 2010 - 2026, TradeNova Broking Ltd. All rights reserved.</p>
                </div>

                <div className='col footer-anchor-tags'>
                    <p>Account</p>
                ...
                <div className='col footer-anchor-tags'>
                    ...
                    <a href=''>Careers </a> <br/>
                    <a href=''>TradeNova Cares (CSR) </a> <br/>
                    <a href=''>TradeNova.tech </a> <br/>
            ...
            <p>TradeNova Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: TradeNova Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@tradeNova.com, for DP related to dp@tradeNova.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF
            </p>
            ...
            <div className='footer-bottom-links ml-5 p-2'>
            <a href=''>NSE</a>
            <a href=''>BSE</a>
            <a href=''>MCX</a>
